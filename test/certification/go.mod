...
require (
	...
	github.com/rancher/turtles/test v0.25.4
...
require (
	...
	sigs.k8s.io/cluster-api-operator v0.23.1 // indirect
	sigs.k8s.io/cluster-api-operator/test v0.23.1 // indirect
...
replace github.com/rancher/turtles => github.com/rancher/turtles v0.25.4
